export const STEP_TYPES = [
  ...
  { value: "checkin",     label: "Progress Update" },
...
export const DEFAULT_AUTOMATIONS = [
  ...
  { triggerType: "weekly_checkin",         messageTemplate: "Time for your weekly progress update. How are things going?", channel: "email" },
];
...
export const AUTOMATION_LABELS: Record<string, string> = {
  ...
  weekly_checkin:        "Weekly progress update reminder",
};
